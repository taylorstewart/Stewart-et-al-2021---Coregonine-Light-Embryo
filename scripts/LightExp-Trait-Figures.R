...
## Embryo Survival
plot.survival <- ggplot(filter(traitsOverall.all, trait == "survival"), aes(x = population, y = (mean.trait*100), group = light, color = light)) + 
...
plot.dpf <- ggplot(filter(traitsOverall.all, trait == "dpf"), aes(x = population, y = mean.trait, group = light, color = light)) + 
  geom_point(size = 5, position = position_dodge(0.6), stroke = 1.5, shape = 1) +
...
plot.add <- ggplot(filter(traitsOverall.all, trait == "ADD"), aes(x = population, y = mean.trait, group = light, color = light)) + 
  geom_point(size = 5, position = position_dodge(0.6), stroke = 1.5, shape = 1) +
  geom_errorbar(aes(ymin = mean.trait - se.trait, ymax = mean.trait + se.trait), 
                position = position_dodge(0.6),
                size = 1, width = 0.25, linetype = "solid", show.legend = FALSE) +
...
## Length-at-Hatch
plot.tl <- ggplot(filter(traitsOverall.all, trait == "LAH"), aes(x = population, y = mean.trait, group = light, color = light)) + 
  geom_point(size = 5, position = position_dodge(0.6), stroke = 1.5, shape = 1) +
  geom_errorbar(aes(ymin = mean.trait - se.trait, ymax = mean.trait + se.trait), 
                position = position_dodge(0.6),
                size = 1, width = 0.25, linetype = "solid", show.legend = FALSE) +
...
## Yolk-sac Volume
plot.ysv <- ggplot(filter(traitsOverall.all, trait == "YSV"), aes(x = population, y = mean.trait, group = light, color = light)) + 
  geom_point(size = 5, position = position_dodge(0.6), stroke = 1.5, shape = 1) +
  geom_errorbar(aes(ymin = mean.trait - se.trait, ymax = mean.trait + se.trait), 
                position = position_dodge(0.6),
                size = 1, width = 0.25, linetype = "solid", show.legend = FALSE) +
...
plot.survival.stand <- ggplot(filter(traitsStand.all, trait == "survival"), aes(x = population, y = mean.trait.stand, group = light, color = light)) + 
  geom_point(size = 5, position = position_dodge(0.6), stroke = 1.5, shape = 1) +
...
plot.dpf.stand <- ggplot(filter(traitsStand.all, trait == "dpf"), aes(x = population, y = mean.trait.stand, group = light, color = light)) + 
  geom_point(size = 5, position = position_dodge(0.6), stroke = 1.5, shape = 1) +
  geom_hline(yintercept = 0, color = "gray30", linetype = "dashed", alpha = 0.5) +
  geom_errorbar(aes(ymin = (mean.trait.stand - se.trait.stand), ymax = (mean.trait.stand + se.trait.stand)), 
                position = position_dodge(0.6), size = 0.8, width = 0.4, show.legend = FALSE) +
...
plot.add.stand <- ggplot(filter(traitsStand.all, trait == "ADD"), aes(x = population, y = mean.trait.stand, group = light, color = light)) + 
  geom_point(size = 5, position = position_dodge(0.6), stroke = 1.5, shape = 1) +
  geom_hline(yintercept = 0, color = "gray30", linetype = "dashed", alpha = 0.5) +
  geom_errorbar(aes(ymin = (mean.trait.stand - se.trait.stand), ymax = (mean.trait.stand + se.trait.stand)), 
                position = position_dodge(0.6), size = 0.8, width = 0.4, show.legend = FALSE) +
...
plot.tl.stand <- ggplot(filter(traitsStand.all, trait == "LAH"), aes(x = population, y = mean.trait.stand, group = light, color = light)) + 
  geom_point(size = 5, position = position_dodge(0.6), stroke = 1.5, shape = 1) +
  geom_hline(yintercept = 0, color = "gray30", linetype = "dashed", alpha = 0.5) +
  geom_errorbar(aes(ymin = (mean.trait.stand - se.trait.stand), ymax = (mean.trait.stand + se.trait.stand)), 
                position = position_dodge(0.6), size = 0.8, width = 0.4, show.legend = FALSE) +
...
plot.ysv.stand <- ggplot(filter(traitsStand.all, trait == "YSV"), aes(x = population, y = mean.trait.stand, group = light, color = light)) + 
  geom_point(size = 5, position = position_dodge(0.6), stroke = 1.5, shape = 1) +
  geom_hline(yintercept = 0, color = "gray30", linetype = "dashed", alpha = 0.5) +
  geom_errorbar(aes(ymin = (mean.trait.stand - se.trait.stand), ymax = (mean.trait.stand + se.trait.stand)), 
                position = position_dodge(0.6), size = 0.8, width = 0.4, show.legend = FALSE) +

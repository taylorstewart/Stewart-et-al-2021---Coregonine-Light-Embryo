...
ggplot(ls.spawn.ice.coord, aes(x = year, y = location, fill = ice.conc)) +
  geom_tile() + 
  scale_fill_gradient(low = "blue", high = "white", limits = c(0.0, 100.0), breaks = c(0.0, 25.0, 50.0, 75.0, 100.0)) +
  theme_bw()

ggplot(lo.spawn.ice.coord, aes(x = year, y = location, fill = ice.conc)) +
  geom_tile() + 
  scale_fill_gradient(low = "blue", high = "white", limits = c(0.0, 100.0), breaks = c(0.0, 25.0, 50.0, 75.0, 100.0)) +
  theme_bw()


ggplot(data = filter(ls.spawn.ice.coord, year == 2019), aes(x = lon, y = lat)) +
  geom_point(color = "black", fill = "goldenrod", shape = 21, size = 3.75) +
